...
export class ItemPedidoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.itemPedidoService
      ...
      .subscribe(
        (res: HttpResponse<IItemPedido[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInItemPedidos(): void {
    this.eventSubscriber = this.eventManager.subscribe('itemPedidoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IItemPedido[] | null, headers: HttpHeaders, page: number): void {
