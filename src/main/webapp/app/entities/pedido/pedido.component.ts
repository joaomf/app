...
export class PedidoComponent implements OnInit, OnDestroy {
  ...
  registerChangeInPedidos(): void {
    this.eventSubscriber = this.eventManager.subscribe('pedidoListModification', () => this.reset());
  }
  ...
  protected paginatePedidos(data: IPedido[] | null, headers: HttpHeaders): void {
