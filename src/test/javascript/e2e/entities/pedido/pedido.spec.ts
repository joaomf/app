...
describe('Pedido e2e test', () => {
  ...
  it('should load Pedidos', async () => {
    ...
    expect(await pedidoComponentsPage.getTitle()).to.eq('appApp.pedido.home.title');
  ...
  it('should load create Pedido page', async () => {
    ...
    expect(await pedidoUpdatePage.getPageTitle()).to.eq('appApp.pedido.home.createOrEditLabel');
  ...
  it('should delete last Pedido', async () => {
    ...
    expect(await pedidoDeleteDialog.getDialogTitle()).to.eq('appApp.pedido.delete.question');
