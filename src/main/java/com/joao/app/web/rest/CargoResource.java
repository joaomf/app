...
/**
 * REST controller for managing {@link com.joao.app.domain.Cargo}.
 */
@RestController
@RequestMapping("/api")
public class CargoResource {
     ...
     */
    @PutMapping("/cargos")
    public ResponseEntity<CargoDTO> updateCargo(@RequestBody CargoDTO cargoDTO) throws URISyntaxException {
